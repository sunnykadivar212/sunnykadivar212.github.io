  ...
  return (
    <div className="grid items-baseline gap-x-10 lg:grid-cols-4">
      ...
      <div className="lg:col-span-3">
        ...
        <span>
          at{" "}
          <a href={companySite} className="text-blue-500">
            {company}
          </a>{" "}
          ({location})
        </span>
        ...
        {projects && (
          <ul className="mx-5 my-2 list-disc">
            {projects.map((project, index) => (
              <li key={index}>
                <a href={project.site} className="text-blue-500">
                  {project.name}
                </a>
                : {project.description}
              </li>
          ...
          <div className="grid items-baseline gap-x-10 lg:grid-cols-4">
            ...
            <div className="lg:col-span-3">
              <h3 className="inline font-bold">
                {data.openSourceContributionsTitle}
              </h3>
              <ul className="mx-5 my-2 list-disc">
                ...
                <li>
                  <a
                    href={data.openSourceContributionsUrl}
        ...
        <Section title="Contact Info" icon={Send}>
          <ul className="mx-5 my-2 list-disc">
            ...
            <ContactItem icon={Linkedin}>
              <ContactLink href={data.linkedinUrl}>
                @{data.linkedinUserName}
              </ContactLink>
            </ContactItem>
            <ContactItem icon={Github}>
              <ContactLink href={data.githubUrl}>
                @{data.githubUserName}
              </ContactLink>
            </ContactItem>
            ...
            <ContactItem icon={Code}>
              <ContactLink href={data.devToUrl}>
                @{data.devToUserName}
              </ContactLink>
            </ContactItem>*/}
            {/*<ContactItem icon={Send}>
              <ContactLink href={data.telegramUrl}>
