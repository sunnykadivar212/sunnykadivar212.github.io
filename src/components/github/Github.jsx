  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-center text-3xl font-bold mb-4">
        <Smile size={24} className="inline-block mr-2" /> Hi, I'm Sunny
      </h1>
      <h3 className="text-center text-xl mb-4">
        A Techie <Code size={24} className="inline-block" /> Software developer
        from India
      </h3>
      ...
      <div className="mt-4 text-left max-w-md mx-auto">
        <ProfileLink icon={Mail} href="#">
          Reach me at <strong>sunnykadivar0689@gmail.com</strong>
        </ProfileLink>
        <ProfileLink icon={Code} href="#">
          All of my projects are available at{" "}
          <a
            href="https://github.com/sunnykadivar212"
            target="_blank"
        ...
        {/*<ProfileLink icon={Globe} href="#">
          <a
            href="https://github.com/mdn/content/pulls?q=is%3Apr+is%3Amerged+author%3AAshish-CodeJourney"
            target="_blank"
            rel="noopener noreferrer"
          >
            Some contributions in MDN web docs
          </a>
        </ProfileLink>*/}
      </div>
      ...
      {/*<div className="mt-4 flex justify-center">
        <img
          src="https://raw.githubusercontent.com/Ashish-CodeJourney/Ashish-CodeJourney/master/assets/terminal.svg"
